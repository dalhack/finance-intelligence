#!/usr/bin/env python3
"""Authoritative Recursive Migration Dependency Lock Generator.

Reads direct dependency authority from services/api/requirements-migration.in,
computes the full recursive dependency closure (including cryptography, cffi, pycparser, scramp),
fetches PyPI metadata for all releases, and writes services/api/requirements-migration.lock.

FAILS CLOSED IMMEDIATELY (exit code 1) on HTTP 404, missing hashes, or unpinned dependencies.
"""
